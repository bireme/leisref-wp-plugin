    ...
    if ( $similar_docs ) {
        ...
        foreach ( $similar_docs as $src => $docs ) {
            ...
            <div class="box4">
                ...
                <ul>
                <?php
                    if ( array_key_exists('document', $docs) && count($docs) > 0 ) {
                        if( !array_key_exists( 0, $docs['document'] ) ) {
                            $docs['document'] = array_values($docs);
                        }
        ...
        <div class="">
            <ul>
                <?php echo '<li>' . __('No related documents', 'leisref') . '</li>'; ?>
            </ul>
        </div>
        <?php
    }
